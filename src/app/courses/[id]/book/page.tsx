        ...
        <div className="md:col-span-2">
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Button variant="outline" className="h-auto py-4 justify-start">
                  <div className="flex flex-col items-start">
                    ...
                    <span className="text-sm text-gray-500">{course.availability.leader} spots available</span>
                  </div>
                </Button>
                <Button variant="outline" className="h-auto py-4 justify-start">
                  <div className="flex flex-col items-start">
                    <span className="text-lg">💃 Follower</span>
                    <span className="text-sm text-gray-500">{course.availability.follower} spots available</span>
                  </div>
                </Button>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 mb-2">Course Fee: {course.price} SEK</p>
              <p className="text-gray-600 mb-4">Payment will be processed securely.</p>
              <Button className="w-full herrang-btn-green">Complete Booking</Button>
            </div>
          </div>
        </div>
            ...
            <div className="p-6">
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{course.week}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold">{course.price} SEK</span>
                </div>
              </div>
            </div>
          </Card>
